...
(function ($) {
    ...
    $('.btn-num-product-down').on('click', function(e){
        ...
        var total = numProduct * price;
        $(this).next().val(numProduct);
        $(this).parent().parent().parent().find('.column-5').text(total + "K");
    });
    ...
    $('.btn-remove-product').on('click', function (e) {
        e.preventDefault();
        var idProduct = Number($(this).parent().parent().attr('id'));
        ...
        $(this).on('click', function () {
            ...
            $.ajax({
                type: "POST",
                url: "http://localhost:81/tmdt/removeProductInCart",
                data: {idProduct: idProduct},
                success: function (response) {
                    swal("Remove successful !", "success");
                    location.reload();
                },
